...
newCopyBanded :: (BLAS1 e, ReadBanded a x e m, WriteBanded b y e m) => 
    a mn e -> m (b mn e)
newCopyBanded a 
    | isHermBanded a =
...
copyBanded :: (BLAS1 e, WriteBanded b y e m, ReadBanded a x e m) =>
    b mn e -> a mn e -> m ()
copyBanded dst src
...
unsafeCopyBanded :: (BLAS1 e, WriteBanded b y e m, ReadBanded a x e m) =>
    b mn e -> a mn e -> m ()
unsafeCopyBanded dst src
    | isHermBanded dst = 
