...
-- and having length @n@.
subvector :: (BaseVector x e, Storable e) => 
    x n e -> Int -> Int -> x n' e
subvector x = checkedSubvector (dim x) (unsafeSubvector x)
{-# INLINE subvector #-}

unsafeSubvector :: (BaseVector x e, Storable e) => 
    x n e -> Int -> Int -> x n' e
...
subvectorWithStride :: (BaseVector x e, Storable e) => 
...
unsafeSubvectorWithStride :: (BaseVector x e, Storable e) => 
    Int -> x n e -> Int -> Int -> x n' e
