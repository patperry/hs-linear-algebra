...
unsafeGetSolveMat :: (MSolve a e m, ReadMatrix c y e m, WriteMatrix b x e m) => 
...
unsafeGetSSolveMat :: (MSolve a e m, ReadMatrix c y e m, WriteMatrix b x e m) => 
...
-- | Solve for a matrix
getSolveMat :: (MSolve a e m, ReadMatrix c y e m, WriteMatrix b x e m) => 
    a (r,s) e -> c (r,t) e -> m (b (s,t) e)                     
getSolveMat a c =
...
getSSolveMat :: (MSolve a e m, ReadMatrix c y e m, WriteMatrix b x e m) => 
    e -> a (r,s) e -> c (r,t) e -> m (b (s,t) e)                 
...
doSolveMat :: (MSolve a e m, ReadMatrix c y e m, WriteMatrix b x e m) => 
    a (r,s) e -> c (r,t) e -> b (s,t) e -> m ()                
doSolveMat a c b =
...
doSSolveMat :: (MSolve a e m, ReadMatrix c y e m, WriteMatrix b x e m) => 
    e -> a (r,s) e -> c (r,t) e -> b (s,t) e -> m ()                  
...
doSolveMat_ :: (MSolve a e m, WriteMatrix b x e m) => 
    a (k,k) e -> b (k,l) e -> m ()          
doSolveMat_ a b =
    checkSquare (shape a) $
        checkMatMatSolv (shape a) (shape b) $
...
doSSolveMat_ :: (MSolve a e m, WriteMatrix b x e m) =>
    e -> a (k,k) e -> b (k,l) e -> m ()          
