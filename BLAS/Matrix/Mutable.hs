...
getSApplyMat :: (MMatrix a e m, ReadMatrix b x e m, WriteMatrix c y e m) =>
    e -> a (r,s) e -> b (s,t) e -> m (c (r,t) e)
getSApplyMat k a b =
...
-- | @c := alpha a b + beta c@
doSApplyAddMat :: (MMatrix a e m, ReadMatrix b x e m, WriteMatrix c y e m) =>
    e -> a (r,s) e -> b (s,t) e -> e -> c (r,t) e -> m ()
...
-- | Apply to a matrix
getApplyMat :: (MMatrix a e m, ReadMatrix b x e m, WriteMatrix c y e m) =>
...
-- | @ b := alpha a b@
doSApplyMat_ :: (MMatrix a e m, WriteMatrix b y e m) =>
    e -> a (s,s) e -> b (s,t) e -> m ()
...
unsafeGetApplyMat :: (MMatrix a e m, ReadMatrix b x e m, WriteMatrix c y e m) =>
    a (r,s) e -> b (s,t) e -> m (c (r,t) e)
...
doApplyMat :: (MMatrix a e m, ReadMatrix b x e m, WriteMatrix c y e m) =>
...
unsafeDoApplyMat :: (MMatrix a e m, ReadMatrix b x e m, WriteMatrix c y e m) =>
    a (r,s) e -> b (s,t) e -> c (r,t) e -> m ()
...
-- | @ b := a b@
doApplyMat_ :: (MMatrix a e m, WriteMatrix b y e m) =>
    a (s,s) e -> b (s,t) e -> m ()
doApplyMat_ a b =
    checkSquare (shape a) $
        checkMatMatMult (shape a) (shape b) $
...
unsafeDoApplyMat_ :: (MMatrix a e m, WriteMatrix b y e m) =>
    a (s,s) e -> b (s,t) e -> m ()
unsafeDoApplyMat_ a b = 
